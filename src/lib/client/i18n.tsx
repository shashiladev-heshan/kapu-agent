...
const STR = {
  ...
  cakeStudio: { en: "Cake Studio", si: "කේක් ස්ටුඩියෝ", ta: "கேக் ஸ்டுடியோ" },
  cakeIcingPh: { en: "Icing text — e.g. Happy Birthday Amma!", si: "Icing එකට — උදා: සුබ උපන්දිනයක් අම්මේ!", ta: "ஐசிங் உரை — எ.கா: பிறந்தநாள் வாழ்த்துக்கள்!" },
  cakeFlavourLabel: { en: "Flavour", si: "රසය", ta: "சுவை" },
  cakeStyleLabel: { en: "Style", si: "විලාසය", ta: "பாணி" },
  ...
  bridgeDelivToggle: {
    en: "Attach my delivery details — they can send it straight to me",
    si: "මගේ delivery විස්තර දාන්න — කෙලින්ම මට එවන්න පුළුවන්",
    ta: "என் டெலிவரி விவரங்களை இணை — நேரடியாக எனக்கு அனுப்பலாம்",
  },
  bridgeDelivNote: {
    en: "Shown to them as name + city only; the full address rides privately into checkout.",
    si: "එයාලට පේන්නේ නම + නගරය විතරයි; සම්පූර්ණ address එක private-ම checkout එකට යනවා.",
    ta: "அவர்களுக்கு பெயர் + நகரம் மட்டுமே தெரியும்; முழு முகவரி தனியாக checkout-க்கு செல்லும்.",
  },
  bridgeCreate: { en: "Create wish link 🎁", si: "Wish link එක හදන්න 🎁", ta: "விஷ் இணைப்பை உருவாக்கு 🎁" },
  bridgeReady: { en: "Your wish link is ready — send it to family or friends:", si: "Wish link එක ready — family/යාළුවන්ට එවන්න:", ta: "உங்கள் விஷ் இணைப்பு தயார் — அனுப்புங்கள்:" },
  bridgeCopy: { en: "Copy link", si: "Link එක copy", ta: "இணைப்பை நகலெடு" },
  bridgeCopied: { en: "Copied ✓", si: "Copy වුණා ✓", ta: "நகலெடுக்கப்பட்டது ✓" },
  bridgeGrant: { en: "Grant this wish 🎁", si: "මේ wish එක ලබා දෙන්න 🎁", ta: "இந்த விஷை வழங்கு 🎁" },
  bridgeGranted: { en: "This wish has been granted 💛", si: "මේ wish එක දැනටමත් ලැබිලා 💛", ta: "இந்த விஷ் வழங்கப்பட்டது 💛" },
  bridgeFor: { en: "for {name} · {city}", si: "{name} ට · {city}", ta: "{name}க்கு · {city}" },
  bridgeOpening: { en: "Opening your basket…", si: "Basket එක ලෑස්ති වෙනවා…", ta: "உங்கள் கூடை திறக்கிறது…" },
  bridgeSub: {
    en: "Someone you love put this together on Kapu. Tap below and it lands in your basket — you pay, Kapruka delivers to them in Sri Lanka.",
    si: "ඔයාට ආදරේ කෙනෙක් මේක Kapu එකේ හදලා. පහළ button එක ඔබන්න — ඔයා ගෙවනවා, Kapruka ලංකාවේ එයාලට ගෙනියනවා.",
    ta: "உங்கள் அன்புக்குரியவர் இதை Kapu-வில் தயாரித்தார். கீழே தட்டுங்கள் — நீங்கள் செலுத்த, Kapruka இலங்கையில் வழங்கும்.",
  },
  ...
  // ── Global Shop — import from Amazon ──────────────────────────────────
  importTitle: { en: "Import from Amazon", si: "Amazon එකෙන් ගෙන්වන්න", ta: "Amazon-இல் இருந்து வரவழை" },
  importSub: { en: "Landed cost to Sri Lanka, via Kapruka", si: "ලංකාවට ගෙන්වන මුළු ගාන — Kapruka හරහා", ta: "இலங்கைக்கு மொத்த செலவு — Kapruka வழியாக" },
  importOnAmazon: { en: "on Amazon", si: "Amazon එකේ", ta: "Amazon-இல்" },
  importItem: { en: "Item price", si: "බඩුවේ ගාන", ta: "பொருள் விலை" },
  importShipDuty: { en: "Shipping + duties + handling", si: "නැව්ගාස්තු + බදු + හැසිරවීම", ta: "கப்பல் + வரி + கையாளுதல்" },
  importTotal: { en: "Landed in Sri Lanka", si: "ලංකාවට ලැබෙනකොට", ta: "இலங்கையில் கிடைக்கும்" },
  importAir: { en: "Air · 7–10 days", si: "Air · දවස් 7–10", ta: "விமானம் · 7–10 நாட்கள்" },
  importSea: { en: "Sea · 30–45 days", si: "Sea · දවස් 30–45", ta: "கப்பல் · 30–45 நாட்கள்" },
  importSwitch: { en: "Show {mode} cost for that import", si: "ඒ import එකට {mode} ගාන පෙන්නන්න", ta: "அந்த import-க்கு {mode} செலவைக் காட்டு" },
  importWeightEst: { en: "Weight ~{w} lb (estimated — final cost may shift)", si: "බර ~{w} lb (ඇස්තමේන්තුවක් — ගාන ටිකක් වෙනස් වෙන්න පුළුවන්)", ta: "எடை ~{w} lb (மதிப்பீடு — செலவு மாறலாம்)" },
  importLocalCompare: { en: "Kapruka SL has similar from {price} — delivered sooner", si: "Kapruka SL එකේ ඒ වගේ එකක් {price} ඉඳන් — ඉක්මනට ලැබෙනවා", ta: "Kapruka SL-இல் இதுபோன்றது {price} முதல் — விரைவில் கிடைக்கும்" },
  importCta: { en: "Order on Kapruka Global Shop", si: "Kapruka Global Shop එකේ order කරන්න", ta: "Kapruka Global Shop-இல் ஆர்டர்" },
  importCopied: { en: "Quote link copied ✓", si: "Quote link එක copy උනා ✓", ta: "மதிப்பீட்டு இணைப்பு நகலெடுக்கப்பட்டது ✓" },
  importShareWa: { en: "Share this quote", si: "මේ quote එක share කරන්න", ta: "இந்த மதிப்பீட்டைப் பகிரவும்" },
  importEstimate: { en: "Kapruka's estimate — final cost confirmed at their checkout.", si: "Kapruka ගේ ඇස්තමේන්තුවක් — නියම ගාන checkout එකේදී තහවුරු වෙනවා.", ta: "Kapruka-வின் மதிப்பீடு — இறுதி செலவு checkout-இல் உறுதி." },
  newTag: { en: "New", si: "අලුත්", ta: "புதியது" },
  importSheetPlaceholder: { en: "Paste an Amazon product link…", si: "Amazon product link එකක් paste කරන්න…", ta: "Amazon தயாரிப்பு இணைப்பை ஒட்டுங்கள்…" },
  importSheetBtn: { en: "Get cost", si: "ගාන බලන්න", ta: "செலவு பார்" },
  importSheetHint: {
    en: "amazon.com / amazon.in links. Kapruka imports it to Sri Lanka — I'll show the full landed cost in LKR right here.",
    si: "amazon.com / amazon.in links. Kapruka ලංකාවට ගෙන්වනවා — මුළු ගාන LKR වලින් මෙතනම පෙන්නන්නම්.",
    ta: "amazon.com / amazon.in இணைப்புகள். Kapruka இலங்கைக்கு வரவழைக்கும் — மொத்த செலவை LKR-இல் இங்கேயே காட்டுவேன்.",
  },
  ...
  editMsg: { en: "Edit & resend", si: "edit කරලා ආයෙ යවන්න", ta: "திருத்தி மீண்டும் அனுப்பு" },
  copyReply: { en: "Copy", si: "Copy කරන්න", ta: "நகலெடு" },
  goodReply: { en: "Good reply", si: "හොඳ උත්තරයක්", ta: "நல்ல பதில்" },
  badReply: { en: "Bad reply", si: "හොඳ නෑ", ta: "மோசமான பதில்" },
  askSelBtn: { en: "Ask Kapu", si: "Kapu ගෙන් අහන්න", ta: "Kapu-விடம் கேள்" },
  askAbout: { en: 'Tell me more about "{sel}"', si: '"{sel}" ගැන තව කියන්න', ta: '"{sel}" பற்றி மேலும் சொல்லுங்கள்' },
  ...
  linkTgHint: {
    ...
    si: "Telegram එකේ @{bot} ට /link, නැත්නම් WhatsApp එකේ Kapu ට “link” එවලා — code එක මෙතන දාන්න:",
