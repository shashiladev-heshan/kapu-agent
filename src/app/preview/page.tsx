...
const blocks: UiBlock[] = [
  ...
  },
  {
    ...
    icing_text: "Happy Birthday Amma!",
    to: "Amma",
    suggestions: ["සුබ උපන්දිනයක් අම්මේ!", "Happy Birthday Amma!", "ආදරෙන් — ඔයාගේ පුතා"],
    products: [
      { id: "cake1", name: "Springtime Birthday Ribbon Cake 1kg", price: 5770, currency: "LKR", image: IMG, category: "cakes", in_stock: true, pick: true },
      { id: "cake2", name: "Happy Birthday Comic Ribbon Cake", price: 4160, currency: "LKR", image: IMG, category: "cakes", in_stock: true },
      { id: "cake3", name: "Blooming Wishes Ribbon Loaf", price: 4050, currency: "LKR", image: IMG, category: "cakes", in_stock: true },
    ],
  },
  ...
  {
    // Global Shop import quote — Amazon → Sri Lanka landed cost + local compare
    type: "import_quote",
    url: "https://www.amazon.com/dp/B09B8V1LZ3",
    handoff_url: "https://www.kapruka.com/globalshop/price_check_auto.jsp",
    checkout_url: "https://www.kapruka.com/globalshop/price_check_view.jsp?cID=KGSCHCK_AMAZON_1786204718489",
    product_name: "Amazon Echo Dot (newest model) — Vibrant sounding speaker with Alexa, Charcoal",
    product_image: "https://m.media-amazon.com/images/I/61J2sQtBYDL._AC_SY300_SX300_QL70_FMwebp_.jpg",
    usd_price: 49.99,
    shipping: "Air",
    weight_lb: 1.8,
    weight_estimated: true,
    hs_code: "85444290",
    hs_text: "Bluetooth Speakers",
    item_lkr: 16696.66,
    ship_duty_lkr: 19966.3,
    total_lkr: 36700,
    usd_ship_duty: 59.78,
    usd_total: 109.77,
  },
