...
### 🛍 Agentic commerce, visually rich (26 tools)
...
Telegram (private + groups) ──────┤──► ONE agent core (26 tools) ──► MCP Shield ──► mcp.kapruka.com
...
- **Agent core**: 26 tools over the Kapruka MCP behind a caching/coalescing/rate-limited shield; dual Claude engines (Messages API + Agent SDK) with automatic billing fallback
